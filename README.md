...
- **Contents**:
  ...
  - **Inverse Analysis Script** (`fatigue_thresholds_prediction.py`): Implements the crack arrest condition (da/dN=0) to determine the critical driving force. It generates the Kitagawa–Takahashi (K-T) diagram and cyclic R-curve, identifying four key parameters: $\sigma_e$, $\Delta K_{\mathrm{th,LC}}$, $d_1$, and $d_2$.
